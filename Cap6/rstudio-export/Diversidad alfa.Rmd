...
De tipo salvaje es tipo silvestre
...
# index= simpson, invsimpson
shannon_genus
```


El índice predeterminado de la función de diversidad es el índice de Shannon, por lo que index = "shannon" se puede omitir
```{r}
...
```{r}
df<-cbind(df_N[2], df_CH[2], df_H[2], df_simp[2], df_J[2])
colnames(df)<-c("Number", "Chao1", "Shannon", "Simpson", "Pielou")
df
```
